...
class OnboardingFragment : BaseFragment<FragmentOnboardingBinding>(FragmentOnboardingBinding::inflate) {
    ...
    private fun createPageData() = listOf(
        ...
        OnboardingPageData(getString(R.string.onboarding_title1), getString(R.string.onboarding_body1), "file:///android_asset/2.mp4", false),
        OnboardingPageData(getString(R.string.onboarding_title1), getString(R.string.onboarding_body1), "file:///android_asset/3.mp4", false),
    )
